...
window.onload = () => {
  ...
  /* Проверяем конкретно значение 'dark' — если в localStorage хранится 'dark',
     применяем тёмную тему, иначе — светлую. Раньше проверялось просто presence
     значения (truthy), из‑за чего любое значение приводило к тёмной теме. */
